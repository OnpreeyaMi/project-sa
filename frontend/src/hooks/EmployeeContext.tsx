...
// interface IEmployee {
//   ID: number; Code?: string; FirstName?: string; LastName?: string; Gender?: string;
//   PositionID?: number; Phone?: string; StartDate?: string;
//   CreatedAt?: string; UpdatedAt?: string; DeletedAt?: string | null;
//   User?: IUser; Position?: IPosition; EmployeeStatus?: IEmployeeStatus;
// }
...
//       id: addr.ID, detail: addr.AddressDetails, latitude: addr.Latitude, longitude: addr.Longitude, isDefault: addr.IsDefault,
//     })),
//   };
// }
...
//     Position: posName ? { ID: posObj?.ID ?? posObj?.id ?? raw?.PositionID ?? 0, PositionName: posName } : undefined,
//     EmployeeStatus: { ID: raw?.EmployeeStatus?.ID ?? 0, StatusName: (statusName || "inactive").toLowerCase(), StatusDescription: statusDescFromDB },
...
//     try {
//       let res = await axios.get(`${API_BASE}/employee/me`, {
//         headers: { Authorization: `Bearer ${user.token}` },
//       });
...
//     } catch (err) {
//       // fallback by employeeId if exists
